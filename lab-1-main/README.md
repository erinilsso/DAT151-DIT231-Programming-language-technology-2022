...
It is recommended to install these via [Stack](https://docs.haskellstack.org/en/stable/install_and_upgrade/) or all at once via the [Haskell platform](https://www.haskell.org/platform/).
